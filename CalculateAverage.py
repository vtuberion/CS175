...
# Vincent Tuberion
# CalculateAverage.py
# Last Modified 2/28/2022 21:47 EST
...
----------------------------------------------------
score 1:	    {score1:.2f}		{determine_grade(score1)}
score 2:	    {score2:.2f}		{determine_grade(score2)}
score 3:	    {score3:.2f}		{determine_grade(score3)}
score 4:	    {score4:.2f}		{determine_grade(score4)}
score 5:	    {score5:.2f}	    {determine_grade(score5)}
Average score:	{calc_average():.2f}	    {determine_grade(calc_average())}''')
